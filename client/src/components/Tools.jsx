      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-8 lg:w-5/6 w-full " >
        <div class="bg-purple-100 py-12 md:col-span-2 rounded-xl">
          ...
          <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-10 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8 items-start">
              <div class="group relative flex flex-col items-center justify-center">
                <PencilSquareIcon
                  alt="Doc Comments"
                  class="w-40 object-center object-cover group-hover:opacity-75 p-4"
                />
                <h3 class="text-sm text-gray-700 mt-4"> Doc Comments </h3>
                <div class="mt-10">
                  <p class="text-xl text-gray-700">
                    Writing clear and concise documentation for your code is
                    crucial, but it can be a tedious and time-consuming task.
                    Our system will analyze your code and provide you with an
                    autogenerated docstring that you can simply copy and paste
                    into your code. It's that easy!
                  </p>
                </div>
              </div>
              <div class="group relative flex flex-col items-center justify-center">
                <ChatBubbleBottomCenterIcon
                  ...
                  class="w-40 object-center object-cover group-hover:opacity-75  p-4"
                />
                <h3 class="text-sm text-gray-700 mt-4"> Explain Code </h3>
                <div class="mt-10">
                  <p class="text-xl text-gray-700">
                    Understanding someone else's code can be a real challenge.
                    But don't worry, we've got you covered. Our AI will analyze
                    the code and provide you with an explanation of how it
                    works. You can even use it to explain your own code to
                    others. Try it now!
                  </p>
                </div>
              </div>
              <div class="group relative flex flex-col items-center justify-center">
                <ArrowTrendingUpIcon
                  ...
                  class="w-40 object-center object-cover group-hover:opacity-75  p-4"
                />
                <h3 class="text-sm text-gray-700 mt-4"> Optimize Code </h3>
                <div class="mt-10">
                  <p class="text-xl text-gray-700">
                    Optimizing your code can be a complex and time-consuming
                    task. Our system will provide you with suggestions on how to
                    make your code faster and more efficient. Try it now and see
                    how much time and effort you can save!
                  </p>
                </div>
              </div>
              <div
...
group relative flex flex-col items-center justify-center"
              >
                ...
                <BugAntIcon
                  ...
                  class="w-40 object-center object-cover group-hover:opacity-75  p-4"
                />
                <h3 class="text-sm text-gray-700 mt-4"> Debug Code </h3>
                <div class="mt-10">
                  <p class="text-xl text-gray-700">
                    Debugging your code can be a frustrating and tedious task.
                    Use artificial intelligence to diagnose your code and
                    find the root cause of errors. Our system will
                    provide you with an explanation of what went wrong and how
                    to fix it. Try it now and see how much stress and hassle you
                    can avoid!
                  </p>
                </div>
              </div>{" "}
          ...
          {docstringLoading[0] ? (
            ...
            <>
              <Editor
                ...
                button={false}
                deafultLanguageId={codeDoc[1]["id"]}
                listbox={false}
              />
              <a href="/app">
