      ...
      <div className="max-w-screen-xl flex flex-col ">
        ...
        <div className="grid lg:grid-cols-2 grid-rows-2 gap-4 mx-6">
          ...
          <Window
            ...
            description="Copy the generated explanation and understand the code better."
          >
              ...
              {loading ? (
                <div class="grid place-content-center h-full">
                  <div role="status">
                    <svg
                      aria-hidden="true"
                      clasName="w-12 h-12 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-700"
                      viewBox="0 0 100 101"
                      fill="none"
