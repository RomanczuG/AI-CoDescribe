    ...
    <nav className="w-full flex py-6 justify-between items-center top-48">
      ...
      <div className="font-poppins font-normal text-white cursor-pointer">
        ...
        <a href="https://old.codescribe.app">
          ...
          <a href="https://old.codescribe.app">
            <button className="cursor-pointer font-semibold ml-10 h-[60px] w-[150px] relative overflow-hidden rounded-lg bg-black px-20 py-6 ring-red-500/50 ring-offset-black will-change-transform">
